...
export const GLOBAL_CHART = gql`
  query becoswapDayDatas($startTime: Int!, $skip: Int!) {
    becoswapDayDatas(first: 1000, skip: $skip, where: { date_gt: $startTime }, orderBy: date, orderDirection: asc) {
      id
      date
      totalVolumeUSD
      dailyVolumeUSD
...
export const GLOBAL_DATA = (block) => {
  const queryString = ` query becoswapFactories {
      becoswapFactories(
